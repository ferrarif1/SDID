...
(function applyStyles() {
  ...
  style.textContent = `
    ...
    .sdid-login-dialog {
      ...
      box-shadow: 0 24px 48px rgba(28, 24, 19, 0.14);
      padding: 22px;
      display: flex;
    ...
    .sdid-login-overlay-exit .sdid-login-dialog {
      ...
      box-shadow: 0 18px 40px rgba(28, 24, 19, 0.12);
    }
    .sdid-login-header {
      display: flex;
      align-items: flex-start;
    ...
    .sdid-login-confirm {
      ...
      color: #f7f6f2;
      box-shadow: 0 18px 32px rgba(28, 24, 19, 0.22);
      position: relative;
      overflow: hidden;
    }
    ...
    @keyframes sdid-confirm-pulse {
      ...
      50% {
        box-shadow: 0 24px 42px rgba(16, 13, 11, 0.32);
      }
      100% {
        box-shadow: 0 18px 32px rgba(28, 24, 19, 0.22);
      }
